...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.datadirr.encrypt_decrypt_plus.EncryptDecryptPlusPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin encrypt_decrypt_plus, com.datadirr.encrypt_decrypt_plus.EncryptDecryptPlusPlugin", e);
    }
    try {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.photo_browser.PhotoBrowserPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin photo_browser, com.example.photo_browser.PhotoBrowserPlugin", e);
    }
    try {
